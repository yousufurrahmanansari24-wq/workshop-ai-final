...
})(EcommerceApiApiKeys || (exports.EcommerceApiApiKeys = EcommerceApiApiKeys = {}));
class EcommerceApi {
    ...
    createBatchOrder(orderBatch_1) {
        return __awaiter(this, arguments, void 0, function* (orderBatch, options = { headers: {} }) {
    ...
    createOrder(order_1) {
        return __awaiter(this, arguments, void 0, function* (order, options = { headers: {} }) {
    ...
    createUpdateBatchCategory(createUpdateBatchCategory_1) {
        return __awaiter(this, arguments, void 0, function* (createUpdateBatchCategory, options = { headers: {} }) {
    ...
    createUpdateBatchProducts(createUpdateBatchProducts_1) {
        return __awaiter(this, arguments, void 0, function* (createUpdateBatchProducts, options = { headers: {} }) {
    ...
    createUpdateCategory(createUpdateCategory_1) {
        return __awaiter(this, arguments, void 0, function* (createUpdateCategory, options = { headers: {} }) {
    ...
    createUpdateProduct(createUpdateProduct_1) {
        return __awaiter(this, arguments, void 0, function* (createUpdateProduct, options = { headers: {} }) {
    ...
    ecommerceAttributionMetricsConversionSourceConversionSourceIdGet(conversionSource_1, conversionSourceId_1) {
        return __awaiter(this, arguments, void 0, function* (conversionSource, conversionSourceId, options = { headers: {} }) {
    ...
    ecommerceAttributionMetricsGet(periodFrom_1, periodTo_1, emailCampaignId_1, smsCampaignId_1, automationWorkflowEmailId_1, automationWorkflowSmsId_1) {
        return __awaiter(this, arguments, void 0, function* (periodFrom, periodTo, emailCampaignId, smsCampaignId, automationWorkflowEmailId, automationWorkflowSmsId, options = { headers: {} }) {
            ...
            if (emailCampaignId !== undefined) {
                localVarQueryParameters['emailCampaignId[]'] = models_1.ObjectSerializer.serialize(emailCampaignId, "Array<string>");
            }
            if (smsCampaignId !== undefined) {
                localVarQueryParameters['smsCampaignId[]'] = models_1.ObjectSerializer.serialize(smsCampaignId, "Array<string>");
            }
            if (automationWorkflowEmailId !== undefined) {
                localVarQueryParameters['automationWorkflowEmailId[]'] = models_1.ObjectSerializer.serialize(automationWorkflowEmailId, "Array<string>");
            }
            if (automationWorkflowSmsId !== undefined) {
                localVarQueryParameters['automationWorkflowSmsId[]'] = models_1.ObjectSerializer.serialize(automationWorkflowSmsId, "Array<string>");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
    ...
    ecommerceAttributionProductsConversionSourceConversionSourceIdGet(conversionSource_1, conversionSourceId_1) {
        return __awaiter(this, arguments, void 0, function* (conversionSource, conversionSourceId, options = { headers: {} }) {
    ...
    getCategories(limit_1, offset_1, sort_1, ids_1, name_1, modifiedSince_1, createdSince_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, ids, name, modifiedSince, createdSince, options = { headers: {} }) {
            const localVarPath = this.basePath + '/categories';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    getOrders(limit_1, offset_1, sort_1, modifiedSince_1, createdSince_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, modifiedSince, createdSince, options = { headers: {} }) {
    ...
    getProducts(limit_1, offset_1, sort_1, ids_1, name_1, priceLte_1, priceGte_1, priceLt_1, priceGt_1, priceEq_1, priceNe_1, categories_1, modifiedSince_1, createdSince_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, ids, name, priceLte, priceGte, priceLt, priceGt, priceEq, priceNe, categories, modifiedSince, createdSince, options = { headers: {} }) {
            const localVarPath = this.basePath + '/products';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    setConfigDisplayCurrency(setConfigDisplayCurrency_1) {
        return __awaiter(this, arguments, void 0, function* (setConfigDisplayCurrency, options = { headers: {} }) {
            const localVarPath = this.basePath + '/ecommerce/config/displayCurrency';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
