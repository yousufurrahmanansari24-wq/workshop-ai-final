...
})(InboundParsingApiApiKeys || (exports.InboundParsingApiApiKeys = InboundParsingApiApiKeys = {}));
class InboundParsingApi {
    ...
    getInboundEmailAttachment(downloadToken_1) {
        return __awaiter(this, arguments, void 0, function* (downloadToken, options = { headers: {} }) {
    ...
    getInboundEmailEvents(sender_1, startDate_1, endDate_1, limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (sender, startDate, endDate, limit, offset, sort, options = { headers: {} }) {
    ...
    getInboundEmailEventsByUuid(uuid_1) {
...
//# sourceMappingURL=inboundParsingApi.js.map