...
})(ContactsApiApiKeys || (exports.ContactsApiApiKeys = ContactsApiApiKeys = {}));
class ContactsApi {
    ...
    addContactToList(listId_1, contactEmails_1) {
        return __awaiter(this, arguments, void 0, function* (listId, contactEmails, options = { headers: {} }) {
    ...
    createAttribute(attributeCategory_1, attributeName_1, createAttribute_1) {
        return __awaiter(this, arguments, void 0, function* (attributeCategory, attributeName, createAttribute, options = { headers: {} }) {
    ...
    createContact(createContact_1) {
        return __awaiter(this, arguments, void 0, function* (createContact, options = { headers: {} }) {
    ...
    createDoiContact(createDoiContact_1) {
        return __awaiter(this, arguments, void 0, function* (createDoiContact, options = { headers: {} }) {
    ...
    createFolder(createFolder_1) {
        return __awaiter(this, arguments, void 0, function* (createFolder, options = { headers: {} }) {
    ...
    createList(createList_1) {
        return __awaiter(this, arguments, void 0, function* (createList, options = { headers: {} }) {
    ...
    deleteAttribute(attributeCategory_1, attributeName_1) {
        return __awaiter(this, arguments, void 0, function* (attributeCategory, attributeName, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/attributes/{attributeCategory}/{attributeName}'
                .replace('{' + 'attributeCategory' + '}', encodeURIComponent(String(attributeCategory)))
                .replace('{' + 'attributeName' + '}', encodeURIComponent(String(attributeName)));
            let localVarQueryParameters = {};
    ...
    deleteContact(identifier_1, identifierType_1) {
        return __awaiter(this, arguments, void 0, function* (identifier, identifierType, options = { headers: {} }) {
            ...
            if (identifierType !== undefined) {
                localVarQueryParameters['identifierType'] = models_1.ObjectSerializer.serialize(identifierType, "'email_id' | 'contact_id' | 'ext_id' | 'phone_id' | 'whatsapp_id' | 'landline_number_id'");
            }
            Object.assign(localVarHeaderParams, options.headers);
            let localVarUseFormData = false;
            let localVarRequestOptions = {
    ...
    deleteFolder(folderId_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, options = { headers: {} }) {
    ...
    deleteList(listId_1) {
        return __awaiter(this, arguments, void 0, function* (listId, options = { headers: {} }) {
    ...
    deleteMultiAttributeOptions(attributeType_1, multipleChoiceAttribute_1, multipleChoiceAttributeOption_1) {
        return __awaiter(this, arguments, void 0, function* (attributeType, multipleChoiceAttribute, multipleChoiceAttributeOption, options = { headers: {} }) {
    ...
    getContactInfo(identifier_1, identifierType_1, startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function* (identifier, identifierType, startDate, endDate, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/{identifier}'
                .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            if (identifierType !== undefined) {
                localVarQueryParameters['identifierType'] = models_1.ObjectSerializer.serialize(identifierType, "'email_id' | 'phone_id' | 'contact_id' | 'ext_id' | 'whatsapp_id' | 'landline_number_id'");
            }
    ...
    getContactStats(identifier_1, startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function* (identifier, startDate, endDate, options = { headers: {} }) {
    ...
    getContacts(limit_1, offset_1, modifiedSince_1, createdSince_1, sort_1, segmentId_1, listIds_1, filter_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, modifiedSince, createdSince, sort, segmentId, listIds, filter, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    getContactsFromList(listId_1, modifiedSince_1, limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (listId, modifiedSince, limit, offset, sort, options = { headers: {} }) {
    ...
    getFolderLists(folderId_1, limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, limit, offset, sort, options = { headers: {} }) {
    ...
    getFolders(limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/folders';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    getList(listId_1, startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function* (listId, startDate, endDate, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/lists/{listId}'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    getLists(limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/lists';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    getSegments(limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, options = { headers: {} }) {
    ...
    importContacts(requestContactImport_1) {
        return __awaiter(this, arguments, void 0, function* (requestContactImport, options = { headers: {} }) {
    ...
    removeContactFromList(listId_1, contactEmails_1) {
        return __awaiter(this, arguments, void 0, function* (listId, contactEmails, options = { headers: {} }) {
    ...
    requestContactExport(requestContactExport_1) {
        return __awaiter(this, arguments, void 0, function* (requestContactExport, options = { headers: {} }) {
    ...
    updateAttribute(attributeCategory_1, attributeName_1, updateAttribute_1) {
        return __awaiter(this, arguments, void 0, function* (attributeCategory, attributeName, updateAttribute, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/attributes/{attributeCategory}/{attributeName}'
                .replace('{' + 'attributeCategory' + '}', encodeURIComponent(String(attributeCategory)))
                .replace('{' + 'attributeName' + '}', encodeURIComponent(String(attributeName)));
            let localVarQueryParameters = {};
    ...
    updateBatchContacts(updateBatchContacts_1) {
        return __awaiter(this, arguments, void 0, function* (updateBatchContacts, options = { headers: {} }) {
    ...
    updateContact(identifier_1, updateContact_1, identifierType_1) {
        return __awaiter(this, arguments, void 0, function* (identifier, updateContact, identifierType, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/{identifier}'
                .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    updateFolder(folderId_1, updateFolder_1) {
        return __awaiter(this, arguments, void 0, function* (folderId, updateFolder, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/folders/{folderId}'
                .replace('{' + 'folderId' + '}', encodeURIComponent(String(folderId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    updateList(listId_1, updateList_1) {
        return __awaiter(this, arguments, void 0, function* (listId, updateList, options = { headers: {} }) {
            const localVarPath = this.basePath + '/contacts/lists/{listId}'
                .replace('{' + 'listId' + '}', encodeURIComponent(String(listId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
