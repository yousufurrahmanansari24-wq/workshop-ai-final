...
})(ExternalFeedsApiApiKeys || (exports.ExternalFeedsApiApiKeys = ExternalFeedsApiApiKeys = {}));
class ExternalFeedsApi {
    ...
    createExternalFeed(createExternalFeed_1) {
        return __awaiter(this, arguments, void 0, function* (createExternalFeed, options = { headers: {} }) {
    ...
    deleteExternalFeed(uuid_1) {
        return __awaiter(this, arguments, void 0, function* (uuid, options = { headers: {} }) {
    ...
    getAllExternalFeeds(search_1, startDate_1, endDate_1, sort_1, authType_1, limit_1, offset_1) {
        return __awaiter(this, arguments, void 0, function* (search, startDate, endDate, sort, authType, limit, offset, options = { headers: {} }) {
            const localVarPath = this.basePath + '/feeds';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    updateExternalFeed(uuid_1, updateExternalFeed_1) {
        return __awaiter(this, arguments, void 0, function* (uuid, updateExternalFeed, options = { headers: {} }) {
            const localVarPath = this.basePath + '/feeds/{uuid}'
                .replace('{' + 'uuid' + '}', encodeURIComponent(String(uuid)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
...
exports.ExternalFeedsApi = ExternalFeedsApi;
//# sourceMappingURL=externalFeedsApi.js.map