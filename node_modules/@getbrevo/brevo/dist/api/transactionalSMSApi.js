...
})(TransactionalSMSApiApiKeys || (exports.TransactionalSMSApiApiKeys = TransactionalSMSApiApiKeys = {}));
class TransactionalSMSApi {
    ...
    getSmsEvents(limit_1, startDate_1, endDate_1, offset_1, days_1, phoneNumber_1, event_1, tags_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (limit, startDate, endDate, offset, days, phoneNumber, event, tags, sort, options = { headers: {} }) {
    ...
    getTransacAggregatedSmsReport(startDate_1, endDate_1, days_1, tag_1) {
        return __awaiter(this, arguments, void 0, function* (startDate, endDate, days, tag, options = { headers: {} }) {
    ...
    getTransacSmsReport(startDate_1, endDate_1, days_1, tag_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (startDate, endDate, days, tag, sort, options = { headers: {} }) {
    ...
    sendTransacSms(sendTransacSms_1) {
        return __awaiter(this, arguments, void 0, function* (sendTransacSms, options = { headers: {} }) {
