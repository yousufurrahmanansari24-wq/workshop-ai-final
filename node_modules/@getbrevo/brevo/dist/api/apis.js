...
__exportStar(require("./balanceApi"), exports);
const balanceApi_1 = require("./balanceApi");
...
const programApi_1 = require("./programApi");
__exportStar(require("./rewardApi"), exports);
const rewardApi_1 = require("./rewardApi");
...
__exportStar(require("./tierApi"), exports);
const tierApi_1 = require("./tierApi");
...
exports.APIS = [accountApi_1.AccountApi, balanceApi_1.BalanceApi, companiesApi_1.CompaniesApi, contactsApi_1.ContactsApi, conversationsApi_1.ConversationsApi, couponsApi_1.CouponsApi, dealsApi_1.DealsApi, domainsApi_1.DomainsApi, ecommerceApi_1.EcommerceApi, emailCampaignsApi_1.EmailCampaignsApi, eventsApi_1.EventsApi, externalFeedsApi_1.ExternalFeedsApi, filesApi_1.FilesApi, inboundParsingApi_1.InboundParsingApi, masterAccountApi_1.MasterAccountApi, notesApi_1.NotesApi, paymentsApi_1.PaymentsApi, processApi_1.ProcessApi, programApi_1.ProgramApi, rewardApi_1.RewardApi, sMSCampaignsApi_1.SMSCampaignsApi, sendersApi_1.SendersApi, tasksApi_1.TasksApi, tierApi_1.TierApi, transactionalEmailsApi_1.TransactionalEmailsApi, transactionalSMSApi_1.TransactionalSMSApi, transactionalWhatsAppApi_1.TransactionalWhatsAppApi, userApi_1.UserApi, webhooksApi_1.WebhooksApi, whatsAppCampaignsApi_1.WhatsAppCampaignsApi];
