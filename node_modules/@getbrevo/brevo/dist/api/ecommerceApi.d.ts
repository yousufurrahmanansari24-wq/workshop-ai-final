...
export declare class EcommerceApi {
    ...
    ecommerceAttributionMetricsConversionSourceConversionSourceIdGet(conversionSource: 'email_campaign' | 'sms_campaign' | 'automation_workflow_email' | 'automation_workflow_sms', conversionSourceId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    ecommerceAttributionMetricsGet(periodFrom?: Date, periodTo?: Date, emailCampaignId?: Array<string>, smsCampaignId?: Array<string>, automationWorkflowEmailId?: Array<string>, automationWorkflowSmsId?: Array<string>, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    ecommerceAttributionProductsConversionSourceConversionSourceIdGet(conversionSource: 'email_campaign' | 'sms_campaign' | 'automation_workflow_email' | 'automation_workflow_sms', conversionSourceId: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
