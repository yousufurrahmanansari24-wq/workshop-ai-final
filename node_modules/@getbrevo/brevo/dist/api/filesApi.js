...
class FilesApi {
    ...
    crmFilesGet(entity_1, entityIds_1, dateFrom_1, dateTo_1, offset_1, limit_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (entity, entityIds, dateFrom, dateTo, offset, limit, sort, options = { headers: {} }) {
    ...
    crmFilesPost(file_1, dealId_1, contactId_1, companyId_1) {
        return __awaiter(this, arguments, void 0, function* (file, dealId, contactId, companyId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/crm/files';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
