...
export declare class ContactsApi {
    ...
    deleteContact(identifier: string, identifierType?: 'email_id' | 'contact_id' | 'ext_id' | 'phone_id' | 'whatsapp_id' | 'landline_number_id', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    deleteMultiAttributeOptions(attributeType: 'multiple-choice', multipleChoiceAttribute: string, multipleChoiceAttributeOption: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getContactInfo(identifier: string, identifierType?: 'email_id' | 'phone_id' | 'contact_id' | 'ext_id' | 'whatsapp_id' | 'landline_number_id', startDate?: string, endDate?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getContacts(limit?: number, offset?: number, modifiedSince?: string, createdSince?: string, sort?: 'asc' | 'desc', segmentId?: number, listIds?: Array<number>, filter?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateAttribute(attributeCategory: 'category' | 'calculated' | 'global' | 'normal', attributeName: string, updateAttribute: UpdateAttribute, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateContact(identifier: string, updateContact: UpdateContact, identifierType?: 'email_id' | 'contact_id' | 'ext_id' | 'phone_id' | 'whatsapp_id' | 'landline_number_id', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
