...
export declare class MasterAccountApi {
    ...
    corporateSubAccountsPlanPut(updatePlanDetails: SubAccountsUpdatePlanRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    corporateUserEmailPermissionsPut(email: string, body: CorporateUserEmailPermissionsPutRequest, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getAccountActivity(startDate?: string, endDate?: string, email?: string, limit?: number, offset?: number, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
