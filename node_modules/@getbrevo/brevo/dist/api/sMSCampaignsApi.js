...
})(SMSCampaignsApiApiKeys || (exports.SMSCampaignsApiApiKeys = SMSCampaignsApiApiKeys = {}));
class SMSCampaignsApi {
    ...
    createSmsCampaign(createSmsCampaign_1) {
        return __awaiter(this, arguments, void 0, function* (createSmsCampaign, options = { headers: {} }) {
    ...
    deleteSmsCampaign(campaignId_1) {
    ...
    getSmsCampaigns(status_1, startDate_1, endDate_1, limit_1, offset_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (status, startDate, endDate, limit, offset, sort, options = { headers: {} }) {
            const localVarPath = this.basePath + '/smsCampaigns';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    requestSmsRecipientExport(campaignId_1, recipientExport_1) {
    ...
    sendSmsCampaignNow(campaignId_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, options = { headers: {} }) {
    ...
    sendSmsReport(campaignId_1, sendReport_1) {
    ...
    sendTestSms(campaignId_1, phoneNumber_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, phoneNumber, options = { headers: {} }) {
    ...
    updateSmsCampaign(campaignId_1, updateSmsCampaign_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, updateSmsCampaign, options = { headers: {} }) {
            const localVarPath = this.basePath + '/smsCampaigns/{campaignId}'
                .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    updateSmsCampaignStatus(campaignId_1, status_1) {
