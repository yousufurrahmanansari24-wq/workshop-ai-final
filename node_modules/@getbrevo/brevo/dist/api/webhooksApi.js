...
})(WebhooksApiApiKeys || (exports.WebhooksApiApiKeys = WebhooksApiApiKeys = {}));
class WebhooksApi {
    ...
    createWebhook(createWebhook_1) {
        return __awaiter(this, arguments, void 0, function* (createWebhook, options = { headers: {} }) {
    ...
    deleteWebhook(webhookId_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, options = { headers: {} }) {
    ...
    exportWebhooksHistory(exportWebhookHistory_1) {
        return __awaiter(this, arguments, void 0, function* (exportWebhookHistory, options = { headers: {} }) {
    ...
    getWebhooks(type_1, sort_1) {
        return __awaiter(this, arguments, void 0, function* (type, sort, options = { headers: {} }) {
            const localVarPath = this.basePath + '/webhooks';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    updateWebhook(webhookId_1, updateWebhook_1) {
        return __awaiter(this, arguments, void 0, function* (webhookId, updateWebhook, options = { headers: {} }) {
            const localVarPath = this.basePath + '/webhooks/{webhookId}'
                .replace('{' + 'webhookId' + '}', encodeURIComponent(String(webhookId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
