...
class CompaniesApi {
    ...
    companiesGet(filters_1, linkedContactsIds_1, linkedDealsIds_1, modifiedSince_1, createdSince_1, page_1, limit_1, sort_1, sortBy_1) {
        return __awaiter(this, arguments, void 0, function* (filters, linkedContactsIds, linkedDealsIds, modifiedSince, createdSince, page, limit, sort, sortBy, options = { headers: {} }) {
    ...
    companiesImportPost(file_1, mapping_1) {
    ...
    companiesLinkUnlinkIdPatch(id_1, body_1) {
        return __awaiter(this, arguments, void 0, function* (id, body, options = { headers: {} }) {
