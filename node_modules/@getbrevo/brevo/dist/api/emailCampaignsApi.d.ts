...
export declare class EmailCampaignsApi {
    ...
    getEmailCampaign(campaignId: number, statistics?: 'globalStats' | 'linksStats' | 'statsByDomain' | 'statsByDevice' | 'statsByBrowser', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getEmailCampaigns(type?: 'classic' | 'trigger', status?: 'suspended' | 'archive' | 'sent' | 'queued' | 'draft' | 'inProcess' | 'inReview', statistics?: 'globalStats' | 'linksStats' | 'statsByDomain', startDate?: string, endDate?: string, limit?: number, offset?: number, sort?: 'asc' | 'desc', excludeHtmlContent?: boolean, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
