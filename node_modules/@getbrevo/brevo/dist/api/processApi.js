...
})(ProcessApiApiKeys || (exports.ProcessApiApiKeys = ProcessApiApiKeys = {}));
class ProcessApi {
    ...
    getProcess(processId_1) {
        return __awaiter(this, arguments, void 0, function* (processId, options = { headers: {} }) {
    ...
    getProcesses(limit_1, offset_1, sort_1) {
