...
})(EmailCampaignsApiApiKeys || (exports.EmailCampaignsApiApiKeys = EmailCampaignsApiApiKeys = {}));
class EmailCampaignsApi {
    ...
    createEmailCampaign(emailCampaigns_1) {
        return __awaiter(this, arguments, void 0, function* (emailCampaigns, options = { headers: {} }) {
    ...
    deleteEmailCampaign(campaignId_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, options = { headers: {} }) {
    ...
    emailExportRecipients(campaignId_1, recipientExport_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, recipientExport, options = { headers: {} }) {
    ...
    getAbTestCampaignResult(campaignId_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, options = { headers: {} }) {
    ...
    getEmailCampaign(campaignId_1, statistics_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, statistics, options = { headers: {} }) {
            const localVarPath = this.basePath + '/emailCampaigns/{campaignId}'
                .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    getEmailCampaigns(type_1, status_1, statistics_1, startDate_1, endDate_1, limit_1, offset_1, sort_1, excludeHtmlContent_1) {
        return __awaiter(this, arguments, void 0, function* (type, status, statistics, startDate, endDate, limit, offset, sort, excludeHtmlContent, options = { headers: {} }) {
            const localVarPath = this.basePath + '/emailCampaigns';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            ...
            if (status !== undefined) {
                localVarQueryParameters['status'] = models_1.ObjectSerializer.serialize(status, "'suspended' | 'archive' | 'sent' | 'queued' | 'draft' | 'inProcess' | 'inReview'");
            }
            if (statistics !== undefined) {
    ...
    getSharedTemplateUrl(campaignId_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, options = { headers: {} }) {
    ...
    sendEmailCampaignNow(campaignId_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, options = { headers: {} }) {
    ...
    sendReport(campaignId_1, sendReport_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, sendReport, options = { headers: {} }) {
    ...
    sendTestEmail(campaignId_1, emailTo_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, emailTo, options = { headers: {} }) {
    ...
    updateCampaignStatus(campaignId_1, status_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, status, options = { headers: {} }) {
    ...
    updateEmailCampaign(campaignId_1, emailCampaign_1) {
        return __awaiter(this, arguments, void 0, function* (campaignId, emailCampaign, options = { headers: {} }) {
            const localVarPath = this.basePath + '/emailCampaigns/{campaignId}'
                .replace('{' + 'campaignId' + '}', encodeURIComponent(String(campaignId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    uploadImageToGallery(uploadImage_1) {
        return __awaiter(this, arguments, void 0, function* (uploadImage, options = { headers: {} }) {
