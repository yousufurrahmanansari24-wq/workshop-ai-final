...
})(DomainsApiApiKeys || (exports.DomainsApiApiKeys = DomainsApiApiKeys = {}));
class DomainsApi {
    ...
    authenticateDomain(domainName_1) {
        return __awaiter(this, arguments, void 0, function* (domainName, options = { headers: {} }) {
    ...
    getDomainConfiguration(domainName_1) {
        return __awaiter(this, arguments, void 0, function* (domainName, options = { headers: {} }) {
            const localVarPath = this.basePath + '/senders/domains/{domainName}'
                .replace('{' + 'domainName' + '}', encodeURIComponent(String(domainName)));
            let localVarQueryParameters = {};
