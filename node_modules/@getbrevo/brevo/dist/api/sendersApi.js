...
})(SendersApiApiKeys || (exports.SendersApiApiKeys = SendersApiApiKeys = {}));
class SendersApi {
    ...
    createSender(sender_1) {
        return __awaiter(this, arguments, void 0, function* (sender, options = { headers: {} }) {
    ...
    deleteSender(senderId_1) {
        return __awaiter(this, arguments, void 0, function* (senderId, options = { headers: {} }) {
    ...
    getSenders(ip_1, domain_1) {
        return __awaiter(this, arguments, void 0, function* (ip, domain, options = { headers: {} }) {
            const localVarPath = this.basePath + '/senders';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json'];
    ...
    updateSender(senderId_1, sender_1) {
        return __awaiter(this, arguments, void 0, function* (senderId, sender, options = { headers: {} }) {
            const localVarPath = this.basePath + '/senders/{senderId}'
                .replace('{' + 'senderId' + '}', encodeURIComponent(String(senderId)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
    ...
    validateSenderByOTP(senderId_1, otp_1) {
        return __awaiter(this, arguments, void 0, function* (senderId, otp, options = { headers: {} }) {
