...
class CouponsApi {
    ...
    createCouponCollection(createCouponCollection_1) {
        return __awaiter(this, arguments, void 0, function* (createCouponCollection, options = { headers: {} }) {
    ...
    createCoupons(createCoupons_1) {
        return __awaiter(this, arguments, void 0, function* (createCoupons, options = { headers: {} }) {
    ...
    getCouponCollections(limit_1, offset_1, sort_1, sortBy_1) {
        return __awaiter(this, arguments, void 0, function* (limit, offset, sort, sortBy, options = { headers: {} }) {
            const localVarPath = this.basePath + '/couponCollections';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
            const produces = ['application/json', 'response'];
    ...
    updateCouponCollection(id_1, updateCouponCollection_1) {
        return __awaiter(this, arguments, void 0, function* (id, updateCouponCollection, options = { headers: {} }) {
            const localVarPath = this.basePath + '/couponCollections/{id}'
                .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this._defaultHeaders);
