...
class UserApi {
    ...
    editUserPermission(updatePermissions_1) {
        return __awaiter(this, arguments, void 0, function* (updatePermissions, options = { headers: {} }) {
    ...
    putRevokeUserPermission(email_1) {
        return __awaiter(this, arguments, void 0, function* (email, options = { headers: {} }) {
    ...
    putresendcancelinvitation(action_1, email_1) {
